...
* Обновлена ​​совместимость с nvda-2024.1;
* Удалена ссылка для загрузки из файла readme, ссылка для загрузки будущих обновлений теперь будет доступна только в магазине дополнений.

## Изменения версии 20231229.0.0 ##

* Добавлена ​​обратная совместимая реализация для поддержки режима речи по требованию, который скоро будет доступен в nvda-2024.1.
